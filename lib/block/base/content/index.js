...
import TreeNode from '@/muya-v2/block/base/treeNode'
import { BACK_HASH, BRACKET_HASH, EVENT_KEYS } from '@/muya-v2/config'
import Selection from '@/muya-v2/selection'
import { diffToTextOp, mixins } from '@/muya-v2/utils'
...
class Content extends TreeNode {
  ...
  listenDOMEvents() {
    const { eventCenter, options } = this.muya
    const { domNode } = this
    const eventIds = [
