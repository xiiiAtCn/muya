 ...
 */
export const conflict = (arr1, arr2) => !(arr1[1] < arr2[0] || arr2[1] < arr1[0])
...
// mixins
export const mixins = (constructor, ...object) => Object.assign(constructor.prototype, ...object)
