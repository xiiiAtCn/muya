...
import dragIcon from '@/muya-v2/assets/icons/drag/2.png'
import { BLOCK_DOM_PROPERTY } from '@/muya-v2/config'
import { throttle, verticalPositionInRect } from '@/muya-v2/utils'
...
class FrontButton {
  ...
  render() {
    ...
    const iconParagraph = renderIcon(i)
    const iconDrag = renderIcon(dragIcon)
