...
import hrIcon from '@/muya-v2/assets/icons/horizontal_line/2.png'
...
import newTableIcon from '@/muya-v2/assets/icons/new_table/2.png'
...
import todoListIcon from '@/muya-v2/assets/icons/todolist/2.png'
import { isOsx } from '@/muya-v2/config'

import ScrollPage from '@/muya-v2/block/scrollPage'
import emptyStates from '@/muya-v2/config/emptyStates'
import { deepCopy } from '@/muya-v2/utils'
...
export const replaceBlockByLabel = ({ block, muya, label, text = '' }) => {
  const { preferLooseListItem, bulletListMarker, orderListDelimiter, frontmatterType } = muya.options
  let newBlock = null
  let state = null
