...
import { beginRules, inlineRules, validateRules } from '@/muya-v2/inlineRenderer/rules'
import {
  correctUrl,
  getAttributes,
  lowerPriority,
  parseSrcAndTitle,
  validateEmphasize
} from '@/muya-v2/inlineRenderer/utils'
import { isLengthEven, union } from '@/muya-v2/utils'
...
export const tokenizer = (src, { highlights = [], hasBeginRules = true, labels = new Map(), options = {} } = {}) => {
  const tokens = tokenizerFac(src, hasBeginRules ? beginRules : null, inlineRules, 0, true, labels, options)
